...
export class FactoryService {
  ...
  getFactorys(
    info?: DataTableInfo
  ): Observable<ResultModel<DataTable<GetFactorysResult>>> {
    const params = this.sharedService.createDataTableParams(info);
    return this.http.get<ResultModel<DataTable<GetFactorysResult>>>(
      ApiUrl.factory,
      {
        params,
      }
