...
export class ProductComponent
  extends BaseDataTable<Product>
  implements OnInit, InitDataTableFunction<Product>, OnDestroy
{
  ...
  create(): void {
    ...
    forkJoin([typeOptions$, factoryOptions$])
      .pipe(
            ...
            data: {
              ...
              dataList: [
                ...
                },
                {
                  ...
                  type: 'number',
                  min: 1,
                  valids: [Validators.required, Validators.min(1)],
                },
                {
    ...
    forkJoin([typeOptions$, factoryOptions$])
      .pipe(
            ...
            data: {
              ...
              dataList: [
                ...
                },
                {
                  ...
                  type: 'select',
                  options: factoryOptions,
                  value: factoryOptions.find((a) => a.text === row.factoryName)
                    ?.value,
                  valids: [Validators.required],
                },
                {
        ...
        switchMap((data) => {
          ...
          } else return forkJoin([of(data)]);
        }),
        filter(([data, pathData]) => {
          if (pathData) return this.apiService.judgeSuccess(pathData);
          else return true;
        }),
  ...
  multipleDelete(rows: Product[]): void {
    this.swalService
      ...
      .pipe(
        ...
        switchMap((deleteArr) =>
          this.productService.batchDeleteProduct(deleteArr)
        ),
        filter((res) => this.apiService.judgeSuccess(res, true)),
        takeUntil(this.destroy$)
      )
